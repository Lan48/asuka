...
2. Guide you to configure a Studio media API key
...
Create a Studio media API key and export it as `STUDIO_API_KEY`.
...
- **Image Generation**: Studio OpenAI-compatible `/images/edits` API
